...
interface RestaurantAddonCategoryScheduleClientProps {
...
export default function RestaurantAddonCategoryScheduleClient({
  restaurantName,
}: RestaurantAddonCategoryScheduleClientProps) {
  ...
  return (
    <div className="space-y-6">
      <AdminPageTitle
        title="Addons category schedule"
        description={`Schedule addon categories for ${restaurantName}.`}
        action={
          <button
            onClick={handleSave}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="text-sm text-slate-500">
              Two time slots per day for the selected addon category.
            </p>
                ...
                <div key={day.day} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Applies to the selected addon category</p>
                    </div>
